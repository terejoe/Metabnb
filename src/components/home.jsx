...
const Home = () => {
    ...
    return ( 
        <div className="home w-full">
            <div className="md:mt-24 mt-10 grid lg:grid-cols-2 grid-rows-2 md:gap-32 md:px-10 px-4">
                <div className="mt-4">
            ...
            <div className="md:hidden p-3">
                ...
                <div className="flex mt-10 input-group flex-row">
                    <input type="search" className="form-control flex-auto px-3.5 py-1.5 placeholder:text-sm font-normal border border-solid border-[#A3A3A3] text-[#B8B8B8] rounded-l-lg focus:outline-none p-2" placeholder="Search for location" aria-label="Search"/>
                    <button className="inline-block px-14 py-2.5 bg-[#A02279] text-white font-medium text-sm rounded-r-lg" type="button">Search</button>
                </div>
            </div>
